...
const contract = require("../artifacts/contracts/bitID.sol/TorNFT.json");
const contractAddress = "0x64c3F73e41cFe2028eB2C616D35BfF146105E95f";
...
async function mintNFT(tokenURI) {
  ...
  const tx = {
    ...
    data: nftContract.methods
      .createNFT("0xEC48cE65474D483a58dE5DFABf690E324214a33C", tokenURI)
      .encodeABI(), // call the createNFT function from our bitID.sol file and pass the account that should receive the minted NFT.
  };
...
mintNFT("https://images.freeimages.com/images/large-previews/af4/french-desert-6-1400167.jpg") // pass the CID to the JSON file uploaded to Pinata
